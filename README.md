...
| SWAYAM_NODE_ID | Environment variable | Stable node identity for Hive Mind (Derived from hostname+seed) |
| GITHUB_REPOSITORY | Environment variable | owner/repo for API calls |
